...
const Card = (props) => {
  return (
    <div
      className={`lg:max-w-[450px] xl:max-w-[300px] max-h-[139px] ${props.cardCss} bg-white border-[2px] border-_borderColor rounded-[6px] p-5 flex flex-col justify-center  flex-shrink-0`}
    >
      <div className="flex">
        ...
        >
          <Image src={props.trendImg} alt="Trending Image" />
